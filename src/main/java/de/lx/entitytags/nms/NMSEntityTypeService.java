...
public class NMSEntityTypeService implements EntityTypeService {
    ...
    public int getEntityTypeId(String minecraftName) {
        return IRegistry.ENTITY_TYPE.a(IRegistry.ENTITY_TYPE.get(MinecraftKey.a(minecraftName.toLowerCase())));
    }

    @Override
    public EntityTypes<?> getEntityType(EntityType entityType) {
        return IRegistry.ENTITY_TYPE.get(MinecraftKey.a(entityType.toString().toLowerCase()));
    }
}